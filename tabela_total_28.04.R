...
tabela_total_um <- readRDS("tabela_total_um.rds")

tabela_total_dois <- readRDS("tabela_total_dois.rds")

tabela_total_tres <- readRDS("tabela_total_tres.rds")

tabela_total_quatro <- readRDS("tabela_total_quatro.rds")

tabela_total_cinco <- readRDS("tabela_total_cinco.rds")
